...
- **Locale**: target country and language (e.g. France / fr, United States / en, United Kingdom / en, Germany / de). This is non-optional, the other systems pass it to every DataForSEO call. If the site is multilingual, capture the primary locale plus the list of alternates.
- 8-15 in-scope content topics
- 5-10 out-of-scope topics (what you do NOT want the writer to cover)
- **Default content type** for new posts (evergreen blog, software docs, news, YMYL, reference). This drives the staleness thresholds in System 4.
...
## Locale
- target_country: <e.g. France>
- target_language: <e.g. fr>
- alternate_locales: <list, or "none">

## Default content type
<evergreen | software | news | ymyl | reference | commercial>
