...
# launchd does not source the user's shell rc files; we set HOME + PATH explicitly.
export HOME="${HOME:-$(eval echo ~)}"
export PATH="$HOME/.local/bin:$HOME/.npm-global/bin:$HOME/Library/Python/3.9/bin:/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:$PATH"
